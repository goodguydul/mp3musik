...
$title='Download Video '.ucwords($name).' - '.$sitename;
	      ...
	      <h1 class="title" style="color: black"><a href="<?php echo $_SERVER['REQUEST_URI']?>"><?php echo $name ;?></a></h1>
	      	...
	      	<div class="main clearfix">	
	      		<div class="embed-responsive embed-responsive-16by9"  align="center">
					<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?php echo $_REQUEST['v']?>"></iframe>
		        </div>	       
		        <div class="detail" style="margin: 30px 0 -10px 0px;">
		        	<p><span>Title: </span><strong>Video <?php echo $name ;?></strong></p>
		          	...
		          	<div class="links clearfix" style="padding-bottom: 20px;padding-top: 20px;" align="center">
			            <span><a href="<?php echo $urls.'/video/download/'.$_REQUEST[v]?>.html" class="button" >Download</a>
