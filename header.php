...
<head>
	...
	<script type="text/javascript" src="<?php echo $urls ?>/include/jquery.js"></script>
	<script type="text/javascript" src="<?php echo $urls ?>/include/jquery-migrate.min.js"></script>
</head>
<body>
	<header id="header" class="clearfix">
		<div class="container clearfix">
  					...
  					<div class="menu-primary-container">
  						<ul id="menu-primary" class="menu">
							...
							<li id="menu-item-15" class="mp3-genre-menu menu-item menu-item-type-custom menu-item-object-custom menu-item-15">
								<a href="#">Genre</a><a href="javascript:;" class="toggle-sub-menu">+</a>
								<ul class="sub-menu">
									<li>
       	...
       	<a class="toggle-menu" href="javascript:;"><span></span><span></span><span></span></a>
		</div>
	</header>