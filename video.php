...
$title ='Video '.ucwords($masbro).' - '.$sitename;
    ...
    <div class="container">
      <header>
        ...
        <h3 class="description">
          Free download <?php echo ucwords($masbro) ?> Video for free
        </h3>
      </header>
  ...
  echo '
        <div class="clearfix" >
            <div class="item item-'.$vid.'" id="iteem-'.$vid.'">
	            ...
	            <div class="detail" style="padding-right: 20px;">
		            ...
		            <div class="buttons clearfix">
		                <a href="'.$urls.'/video/streaming/'.$vid.'.html" class="button"  title="'.$title.'">Streaming </a>
		                <a href="'.$urls.'/video/download/'.$vid.'.html" title="'.$title.'">Download</a>
		            </div> 
            	</div>
            </div>
            <div class="item item-'.$vidzz.'" id="iteem-'.$vidzz.'">
	                ...
	                <div class="buttons clearfix">
	                	<a href="'.$urls.'/video/streaming/'.$vidzz.'.html" class="button"  title="'.$titlezz.'">Streaming </a>
	                  <a href="'.$urls.'/video/download/'.$vidzz.'.html" title="'.$titlezz.'">Download</a>
	                </div>
              	</div>
            </div>
          </div>';
...
<?php 
echo '<div class="list2" align="center">';
$content = get_contents('https://www.youtube.com/results?'.$page.'q='.$_REQUEST['q'].'');
